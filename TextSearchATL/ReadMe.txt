========================================================================
    ACTIVE TEMPLATE LIBRARY : TextSearchATL Project Overview
========================================================================

AppWizard has created this TextSearchATL project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

TextSearchATL.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

TextSearchATL.vcxproj.filters
...
TextSearchATL.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (TextSearchATL.h)
        GUID definitions                                (TextSearchATL_i.c)
        A type library                                  (TextSearchATL.tlb)
        Marshaling code                                 (TextSearchATL_p.c and dlldata.c)

TextSearchATL.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in TextSearchATL.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named TextSearchATL.pch and a precompiled types file named StdAfx.obj.
...
TextSearchATLps.vcxproj
	...
	dlldata.c, TextSearchATL_i.c and TextSearchATL_p.c which are required
	to build the proxy/stub DLL.

TextSearchATLps.vcxproj.filters

========================================================================
    ACTIVE TEMPLATE LIBRARY : FileMgrATL Project Overview
========================================================================

AppWizard has created this FileMgrATL project for you to use as the starting point for
...
FileMgrATL.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (FileMgrATL.h)
        GUID definitions                                (FileMgrATL_i.c)
        A type library                                  (FileMgrATL.tlb)
        Marshaling code                                 (FileMgrATL_p.c and dlldata.c)

FileMgrATL.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in FileMgrATL.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named FileMgrATL.pch and a precompiled types file named StdAfx.obj.
...
FileMgrATLps.vcxproj
	...
	dlldata.c, FileMgrATL_i.c and FileMgrATL_p.c which are required
	to build the proxy/stub DLL.

FileMgrATLps.vcxproj.filters
